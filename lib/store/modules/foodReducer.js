...
export const updateAction = ({ storeCode, foodName, foodCost, foodCnt, options }) => ({
...
const foodReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case UPDATE_SHOPPING:
      const { storeCode, foodName, foodCost, foodCnt, options } = action;
      const newState = [...state];
      newState.push({ storeCode, foodName, foodCost, foodCnt, options });
      return newState;
