...
export const updateAction = ({ storeName, foodName, foodCost, options }) => ({
...
const foodReducer = (state = initialState, action) => {
  ...
  switch (action.type) {
    ...
    case UPDATE_SHOPPING:
      const { storeName, foodName, foodCost, options } = action;
      ...
      newState.push({ storeName, foodName, foodCost, options });
      return newState;
    default:
      return state;
  }
